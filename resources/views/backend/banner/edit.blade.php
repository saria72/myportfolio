        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 ">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Edit Banner <a href="{{ route('backend.banner.index') }}"
                                    class="btn btn-sm btn-primary">All Banner</a> </h2>
                        ...
                        <div class="x_content">
                            ...
                            <form action="{{ route('backend.banner.update', $banner->id) }}" method="POST"
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div class="col-md-9 col-sm-9 ">
                                        <input type="file" class="form-control" name="photo" onchange="document.getElementById('preImg').src = window.URL.createObjectURL(this.files[0])">
                                        <img class="mt-3" id="preImg" src="{{ asset('storage/banner/' . $banner->photo) }}" width="100" alt="">
                                    </div>
